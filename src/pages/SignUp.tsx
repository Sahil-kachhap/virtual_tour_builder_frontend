      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md glass-panel rounded-xl p-8 shadow-md animate-fade-up">
          <div className="text-center mb-8">
            ...
            <p className="text-tour-medium-gray mt-2">Join our community of tour enthusiasts</p>
          </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-tour-dark">Confirm Password</FormLabel>
                    <FormControl>
                      <div className="relative">
                        <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-tour-medium-gray" />
                        <Input 
                  ...
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0 mt-4">
                    ...
                    <div className="space-y-1 leading-none">
                      <FormLabel className="text-sm text-tour-medium-gray">
                        I agree to the <Link to="/terms" className="text-tour-blue hover:underline">Terms and Conditions</Link>
                      </FormLabel>
                      <FormMessage />
                    </div>
                  </FormItem>
